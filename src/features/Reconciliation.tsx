...
const Reconciliation: React.FC = () => {
    ...
    const canCreateJournal = profile?.role === 'admin' || profile?.role === 'staff';
    ...
    const handleDownloadTemplate = () => {
        ...
        worksheet['!cols'] = [ { wch: 15 }, { wch: 40 }, { wch: 20 }, { wch: 20 } ];
    ...
    const {unmatchedBank, unmatchedApp} = useMemo(() => {
                ...
                <table className="w-full text-sm">
                    <thead>
                        <tr className="border-b border-gray-600">
                            ...
                            {isBankTable && canCreateJournal && <th className="text-center py-2 px-2">Aksi</th>}
                        </tr>
                    </thead>
                    <tbody>
                        {items.length > 0 ? items.map(tx => (
                            <tr key={tx.id} className="border-b border-gray-700">
                                ...
                                {isBankTable && canCreateJournal && <td className="py-2 px-2 text-center">
                             ...
                             <tr><td colSpan={isBankTable && canCreateJournal ? 5 : 4} className="text-center text-gray-400 py-6">Tidak ada data.</td></tr>
                        )}
                    </tbody>
                </table>
            </div>
