...
import { CACHE_KEYS } from '../contexts/DataContext';
    ...
    const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        reader.onload = (e) => {
            try {
                ...
                if (window.confirm('PERINGATAN: Tindakan ini akan menimpa SEMUA data yang ada saat ini. Apakah Anda yakin ingin melanjutkan?')) {
                    ...
                    alert('Data berhasil dipulihkan. Aplikasi akan dimuat ulang sekarang.');
    ...
    return (
         <div className="space-y-4">
            <p className="text-sm text-gray-400">
                Simpan semua data Anda ke dalam satu file, atau pulihkan dari file backup sebelumnya. Berguna untuk memindahkan data antar perangkat atau sebagai cadangan.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                    {isRestoring ? 'Memproses...' : 'Restore Data dari File'}
                </button>
            </div>
        </div>
    );
    ...
    return (
        <div>
            <div className="flex flex-col sm:flex-row gap-4 mb-4">
             ...
             <p className="text-center text-sm text-gray-400 mb-6 py-4 border-t border-b border-slate-700">Anda dapat mengimpor data dari file, atau mengisi formulir di bawah secara manual.</p>
        ...
        <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-1 gap-6 md:gap-8">
                <Card>
                 ...
                 <Card>
                    <h3 className="text-xl font-semibold mb-4">Manajemen Data & Backup</h3>
                    <DataManagement />
                </Card>
                 <Card>
                    <h3 className="text-xl font-semibold mb-4">Statistik Data Lokal</h3>
                    <DataStatistics />
                </Card>
            </div>
        </div>
